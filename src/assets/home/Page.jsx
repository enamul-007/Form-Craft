...
export default function UserManagementList() {
    ...
    const getStatusColor = (status) => (status === 'active' ? 'bg-green-500' : 'bg-gray-400');
            ...
            <div className="bg-white border-b border-slate-200 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 cursor-pointer"
                    >
                        <Plus size={20} />
                        Create New User
                    </button>
                        ...
                        <div className="divide-y divide-slate-200">
                            {filteredUsers.map(user => (
                                <div
                                    ...
                                    className="flex items-center gap-4 p-6 hover:bg-slate-50 cursor-pointer transition-all duration-200 group"
                                >
                                    <div className="relative">
                                        <div className="w-14 h-14 bg-linear-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
